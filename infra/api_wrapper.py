...
class APIWrapper:
    ...
    def __init__(self):
        self.response = None
        pet_data_file_path = 'C:\Users\saher\OneDrive\קבצים מצורפים\שולחן העבודה\repos\WorldCatSeleniumGrid\pet_data.json'
        config_file_path = 'C:\Users\saher\OneDrive\קבצים מצורפים\שולחן העבודה\repos\WorldCatSeleniumGrid\config_Pet_swagger.json'
        store_file_path = 'C:\Users\saher\OneDrive\קבצים מצורפים\שולחן העבודה\repos\WorldCatSeleniumGrid\store.json'
