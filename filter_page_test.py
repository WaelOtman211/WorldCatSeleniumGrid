...
class FilterTest(unittest.TestCase):
    ...
    def test_fill_filter_search_and_reset(self):
        driver = self.browser.get_driver(self.browser.default_browser)
...
"""
    def test_fill_filter_search_and_check_book_year(self):
        driver = self.browser.get_driver(self.browser.default_browser)
        self.browser.get_url(driver)
        filter = FilterPage(driver)
